  ...
  return (
    <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 lg:col-span-2">
          ...
          {tab === "matrix" ? (
            <div className="overflow-x-auto">
              ...
              <button className="mt-3 flex items-center gap-1 rounded-lg border border-gray-200 px-3 py-1.5 text-[11px] text-gray-600">
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-5">
        ...
        <button className="mt-3 text-[11px] text-primary-dark">مشاهده همه لاگ‌ها</button>
      </div>
    </div>
  );
}
