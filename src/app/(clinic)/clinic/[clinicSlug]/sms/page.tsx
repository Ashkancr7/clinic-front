      ...
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="flex items-center gap-2 text-xl font-bold text-gray-900">
            مرکز پیام‌ها / چت <MessageCircle className="h-5 w-5 text-primary-dark" />
          </h1>
      ...
      <div className="grid flex-1 grid-cols-1 gap-4 overflow-hidden lg:grid-cols-[280px_1fr_280px]">
          ...
          <div className="flex-1 overflow-y-auto">
            {CONVERSATIONS.map((c) => (
              <button
                ...
                className={`flex w-full items-start gap-2.5 border-b border-gray-50 p-3 text-right ${
                  activeConversation === c.id ? "bg-primary-light/10" : "hover:bg-gray-50"
                }`}
              >
        ...
        <div className={`flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white ${mobileView === "thread" ? "flex" : "hidden lg:flex"}`}>
          <div className="flex items-center justify-between border-b border-gray-100 p-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="relative h-9 w-9 shrink-0 rounded-full bg-gray-100">
                {current.unread && (
              ...
              <div key={i} className={`flex ${m.fromMe ? "justify-end" : "justify-start"}`}>
                <div
                  className={`max-w-[85%] rounded-2xl px-4 py-2.5 text-xs leading-relaxed sm:max-w-sm ${
                    m.fromMe ? "rounded-bl-sm bg-primary-light/15 text-gray-700" : "rounded-br-sm bg-gray-50 text-gray-700"
                  }`}
                >
                  {m.text}
        ...
        <div className="hidden flex-col gap-4 overflow-y-auto lg:flex">
          <div className="rounded-2xl border border-gray-100 bg-white p-4 text-center">
            <div className="mx-auto mb-2 h-16 w-16 rounded-full bg-gray-100" />
