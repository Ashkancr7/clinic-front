...
const TABS = [
  ...
  { key: "medical", label: "سوابق پزشکی" },
  { key: "services", label: "خدمات انجام‌شده" },
  { key: "gallery", label: "تصاویر قبل و بعد" },
  { key: "notes", label: "یادداشت‌های جلسه" },
  { key: "appointments", label: "نوبت‌ها" },
  { key: "chat", label: "پیام‌ها" },
  { key: "files", label: "فایل‌ها" },
  { key: "consents", label: "رضایت‌نامه‌ها" },
];
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-5">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-5">
          ...
          <InfoStat label="وضعیت" custom={<span className="rounded-full bg-primary-light/20 px-2.5 py-0.5 text-[11px] text-primary-dark">فعال</span>} />
          <InfoStat label="آخرین مراجعه" value="۱۴۰۳/۰۳/۲۱" />
          <InfoStat
            label="شماره تماس"
            custom={
              <span className="flex items-center gap-1 text-gray-700" dir="ltr">
                <Phone className="h-3 w-3 text-gray-300" /> 0912 123 4567
              </span>
            }
          />
          <InfoStat label="تاریخ تولد / سن" value="۱۳۷۵/۰۶/۱۵ - ۲۸ سال" className="hidden lg:block" />
        </div>
        ...
        <div className="mt-4 flex items-center justify-between border-t border-gray-50 pt-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-base font-bold text-gray-900">نسترن موسوی</span>
              </div>
          ...
          <div className="text-left text-[10px] text-gray-300" dir="ltr">
            کد ملی: ۱۲۳۴۵۶۷۸۹۰ · شناسه: {patientId}
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-gray-100 bg-white p-4">
              <div className="mb-3 flex items-center justify-between">
                <h3 className="text-xs font-bold text-gray-800">نوبت بعدی</h3>
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-gray-100 bg-white p-4">
              ...
              <div className="mb-2 flex items-center gap-2 border-b border-gray-100 pb-2 text-gray-300">
              ...
              <textarea
                ...
                rows={5}
                className="w-full resize-none text-xs leading-relaxed text-gray-600 outline-none"
              />
...
function InfoStat({
  ...
  return (
    <div className={className}>
      ...
      {custom ?? <div className={`mt-0.5 text-xs font-medium ${valueTone ?? "text-gray-700"}`}>{value}</div>}
    </div>
  );
}
