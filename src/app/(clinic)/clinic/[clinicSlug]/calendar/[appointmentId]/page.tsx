      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-4 dark:border-white/10 dark:bg-white/[0.06]">
            ...
            <button
              type="button"
              className="mt-4 w-full rounded-xl bg-primary py-2.5 text-xs font-medium text-white transition hover:bg-primary-dark dark:bg-primary/90 dark:hover:bg-primary"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-4 dark:border-white/10 dark:bg-white/[0.06]">
            ...
            <div className="mt-2 flex items-center justify-between gap-2 text-[10px] text-gray-300 dark:text-gray-600">
              <span>
                آخرین ویرایش: دکتر سارا محمدی - ۲۲
                خرداد ۱۴۰۳ - ۱۱:۲۰
              </span>
...
function SelectField({
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between rounded-xl border border-gray-200 px-3 py-2 transition hover:bg-gray-50 dark:border-white/10 dark:bg-white/[0.03] dark:hover:bg-white/10">
