  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white px-5">
      <div className="w-full max-w-sm rounded-3xl border border-gray-100 p-6 shadow-xl">
        <h1 className="mb-2 text-xl font-bold text-gray-900">تایید کد ورود</h1>
        <p className="mb-6 text-sm text-gray-500">کد ارسال‌شده به {phone} را وارد کنید</p>

        {error && <p className="mb-4 rounded-lg bg-red-50 px-3 py-2 text-xs text-red-500">{error}</p>}
